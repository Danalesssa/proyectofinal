    ...
    <div class="container-fluid">
        <div class="row">
                <div class="banner-blocks">
                    ...
                    <div class="banner-ad bg-success-subtle block-2 fenty-banner">
                        <div class="row banner-content">
                            <div class="content-wrapper col-md-7">
                                ...
                                <a href="marca.php?nombre=Fenty%20Beauty" class="d-flex align-items-center nav-link">Ver Fenty Beauty
                    ...
                    <!--banner3 -->
                    <div class="banner-ad block-3 chart-banner">
                        <div class="row banner-content">
                            <div class="content-wrapper col-md-7">
                                <div class="categories sale mb-3 pb-3">TENDENCIA</div>
                                <h3 class="item-title">Charlotte Tilbury Nude Palette</h3>
                                <a href="marca.php?nombre=Charlotte%20Tilbury" class="d-flex align-items-center nav-link">Ver Charlotte Tilbury
                                    <svg width="24" height="24"></svg>
                                </a>
                            </div>
                        </div>
...
<section class="py-5">
    <div class="container-fluid">
        ...
        <a href="todos.php" class="ver-todos-link">Ver todos <span>&rarr;</span>
        </a>
        </div>
